            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-8">
                <form action="{{ route('post.store') }}" enctype="multipart/form-data" method="post">
                    ...
                    <div class="mt-4">
                        ...
                        <x-input-textarea id="content" class="block mt-1" name="content" required>{{ old('content')}}</x-input-textarea>
                    ...
                    <div class="mt-4">
                        ...
                        <p class="text-sm text-gray-500 mt-1">Leave empty to publish immediately, or select a future date to schedule the post.</p>
